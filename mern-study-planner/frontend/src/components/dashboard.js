...
const Dashboard = () => {
  ...
  useEffect(() => {
    const staticTasks = [
      { taskid: 1, task: "Math Homework", subject: "Math", desc: "Algebra problems", startdate: "2025-03-10", deadline: "2025-03-15", completed: true, precentComp: 100 },
      { taskid: 2, task: "Science Report", subject: "Science", desc: "Write about Newton's Laws", startdate: "2025-03-12", deadline: "2025-04-20", completed: false, precentComp: 50 },
      { taskid: 3, task: "History Essay", subject: "History", desc: "World War II analysis", startdate: "2025-03-05", deadline: "2025-03-10", completed: false, precentComp: 0 },
      { taskid: 4, task: "Project Submission", subject: "Computer Science", desc: "Final year project", startdate: "2025-03-12", deadline: "2025-03-18", completed: false, precentComp: 75 }
    ];
